# BlinVPN - Полная система управления VPN сервисом
...
│   ├── api/             # API интеграции (Remnawave, YooKassa, Heleket, Platega)
...
- `POST /yookassa` - Webhook от YooKassa
- `POST /heleket` - Webhook от Heleket
