...
async def cmd_start(message: types.Message):
    ...
    text = (
        '<tg-emoji emoji-id="5438346255153538764">🔥</tg-emoji> <b>Добро пожаловать в БлинВПН!</b>\n\n'
        'Мы — безопасный VPN, который использует <b>лучшие протоколы</b> для обхода блокировок.\n'
        '<b>Не верите?</b> Попробуйте 3 дня бесплатно!\n\n'
        '<b>Нажми на кнопку ниже, чтобы открыть мини-приложение</b> или перейдите на сайт blinvpn.com <tg-emoji emoji-id="5305522282695768654">👇</tg-emoji>'
    )
