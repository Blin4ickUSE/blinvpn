...
async def cmd_start(message: types.Message):
    ...
    text = (
        '<tg-emoji emoji-id="5438346255153538764">🔥</tg-emoji> <b>Привет! Это BlinVPN.</b>\n\n'
        'Уже год стабильно <b>обходим блокировки</b> (и белые списки) по низким ценам.\n\n'
        '<b>Начните использовать прямо сейчас!</b>'
    )
