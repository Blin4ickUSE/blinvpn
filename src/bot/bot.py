...
async def cmd_start(message: types.Message):
    ...
    text = (
        '<tg-emoji emoji-id="5438346255153538764">🔥</tg-emoji> <b>Добро пожаловать!</b>\n\n'
        'Это BlinVPN: используем <b>лучшие протоколы</b> для обхода блокировок.\n'
        '<b>Не верите?</b> Попробуйте 3 дня бесплатно!\n\n'
        '<b>Нажми на кнопку, чтобы открыть мини-приложение</b> или перейдите на сайт blinvpn.com 👇'
    )
